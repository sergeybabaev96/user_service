...
public class GoalInvitationInvitedIdFilter implements GoalInvitationFilter {
    ...
    public boolean isApplicable(InvitationFilterDto goalInvitationDto) {
        return goalInvitationDto.invitedId() != null;
    }

    @Override
    public Stream<GoalInvitation> apply(Stream<GoalInvitation> goalInvitations, InvitationFilterDto goalInvitationDto) {
        return goalInvitations.filter(goalInvitation -> goalInvitation.getInvited().getId().equals(goalInvitationDto.invitedId()));
    }
}
