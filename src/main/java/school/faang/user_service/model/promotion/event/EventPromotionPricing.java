...
public class EventPromotionPricing {
    ...
    static {
        prices.put(EventPromotionType.TEN_PERCENT_OF_USERS.getUserPercentage(), new BigDecimal("30.00"));
        prices.put(EventPromotionType.TWENTY_FIVE_PERCENT_OF_USERS.getUserPercentage(), new BigDecimal("40.00"));
        prices.put(EventPromotionType.FORTY_PERCENT_OF_USERS.getUserPercentage(), new BigDecimal("50.00"));
        prices.put(EventPromotionType.FIFTY_PERCENT_OF_USERS.getUserPercentage(), new BigDecimal("60.00"));
        prices.put(EventPromotionType.SIXTY_PERCENT_OF_USERS.getUserPercentage(), new BigDecimal("70.00"));
