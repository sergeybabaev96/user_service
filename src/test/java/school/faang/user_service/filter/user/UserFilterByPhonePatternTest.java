...
class UserFilterByPhonePatternTest {
    ...
    private static final UserFilterDto PRESET1 = UserFilterDto.builder().phonePattern(PATTERN1).build();
    private static final UserFilterDto PRESET2 = UserFilterDto.builder().phonePattern(PATTERN2).build();
    ...
    @BeforeAll
    static void init() {
        filter = new UserFilterByPhonePattern();
    }

    @BeforeEach
    void setUp() {
        users = Stream.of(
                User.builder().phone(CONTENT1).build(),
                User.builder().phone(CONTENT2).build(),
                User.builder().phone(CONTENT3).build()
        );
    }
